...
export default function UserOrderPage() {
  ...
  useEffect(() => {
    ...
    // Check for stored user name in localStorage
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select your sandwiches for today&apos;s order.
            {isPastCutoffTime() && (
              <span className="text-red-600 ml-2 font-medium">
                Note: It&apos;s past the 11:00 PM cutoff time. Your order will
                be for tomorrow.
              </span>
            )}
          </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-6 mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
              ...
              <div className="p-4">
                ...
                {isLoading ? (
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="font-medium mb-2">No sandwiches available</p>
                    <p className="text-sm">
